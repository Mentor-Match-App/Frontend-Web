...
class ComsciKuliahScreen extends StatefulWidget {
  ComsciKuliahScreen({Key? key}) : super(key: key);

  @override
  State<ComsciKuliahScreen> createState() => _ComsciKuliahScreenState();
}

class _ComsciKuliahScreenState extends State<ComsciKuliahScreen> {
