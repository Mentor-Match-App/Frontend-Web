...
import 'package:my_flutter_app/mentee/screen/PremiumClass/Kuliah/detail_mentor_kuliah_screen.dart';
...
class InformatikaKuliahScreen extends StatefulWidget {
  InformatikaKuliahScreen({Key? key}) : super(key: key);

  @override
  State<InformatikaKuliahScreen> createState() =>
      _InformatikaKuliahScreenState();
}

class _InformatikaKuliahScreenState extends State<InformatikaKuliahScreen> {
