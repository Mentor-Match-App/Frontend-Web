...
class PsikologiKuliahScreen extends StatefulWidget {
  PsikologiKuliahScreen({Key? key}) : super(key: key);

  @override
  State<PsikologiKuliahScreen> createState() => _PsikologiKuliahScreenState();
}

class _PsikologiKuliahScreenState extends State<PsikologiKuliahScreen> {
