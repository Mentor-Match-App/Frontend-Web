...
class ElektroKuliahScreen extends StatefulWidget {
  ElektroKuliahScreen({Key? key}) : super(key: key);

  @override
  State<ElektroKuliahScreen> createState() => _ElektroKuliahScreenState();
}

class _ElektroKuliahScreenState extends State<ElektroKuliahScreen> {
