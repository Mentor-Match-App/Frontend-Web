...
class DesainKarierScreen extends StatefulWidget {
  DesainKarierScreen({Key? key}) : super(key: key);

  @override
  State<DesainKarierScreen> createState() => _DesainKarierScreenState();
}

class _DesainKarierScreenState extends State<DesainKarierScreen> {
