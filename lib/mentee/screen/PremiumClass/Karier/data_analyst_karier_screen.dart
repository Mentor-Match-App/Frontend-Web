...
class DataAnalystKarierScreen extends StatefulWidget {
  DataAnalystKarierScreen({Key? key}) : super(key: key);

  @override
  State<DataAnalystKarierScreen> createState() =>
      _DataAnalystKarierScreenState();
}

class _DataAnalystKarierScreenState extends State<DataAnalystKarierScreen> {
