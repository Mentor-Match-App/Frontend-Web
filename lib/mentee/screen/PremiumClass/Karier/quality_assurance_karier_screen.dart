...
import 'package:my_flutter_app/mentee/screen/PremiumClass/Karier/detail_mentor_karier_screen.dart';
...
class QualityAssuranceKarierScreen extends StatefulWidget {
  QualityAssuranceKarierScreen({Key? key}) : super(key: key);

  @override
  State<QualityAssuranceKarierScreen> createState() =>
      _QualityAssuranceKarierScreenState();
}

class _QualityAssuranceKarierScreenState
    extends State<QualityAssuranceKarierScreen> {
