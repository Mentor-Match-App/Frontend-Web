...
import 'package:my_flutter_app/mentee/screen/PremiumClass/SMA/detail_mentor_sma_screen.dart';
...
class MatematikaSMAScreen extends StatefulWidget {
  MatematikaSMAScreen({Key? key}) : super(key: key);

  @override
  State<MatematikaSMAScreen> createState() => _MatematikaSMAScreenState();
}

class _MatematikaSMAScreenState extends State<MatematikaSMAScreen> {
