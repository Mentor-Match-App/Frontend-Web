...
class TeknologiSMAScreen extends StatefulWidget {
  TeknologiSMAScreen({Key? key}) : super(key: key);

  @override
  State<TeknologiSMAScreen> createState() => _TeknologiSMAScreenState();
}

class _TeknologiSMAScreenState extends State<TeknologiSMAScreen> {
