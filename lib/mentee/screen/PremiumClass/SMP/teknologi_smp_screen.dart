...
class TeknologiSMPScreen extends StatefulWidget {
  TeknologiSMPScreen({Key? key}) : super(key: key);

  @override
  State<TeknologiSMPScreen> createState() => _TeknologiSMPScreenState();
}

class _TeknologiSMPScreenState extends State<TeknologiSMPScreen> {
