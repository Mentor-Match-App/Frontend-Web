...
import 'package:my_flutter_app/mentee/screen/PremiumClass/SMP/detail_mentor_smp_screen.dart';
...
class MatematikaSMPScreen extends StatefulWidget {
  MatematikaSMPScreen({Key? key}) : super(key: key);

  @override
  State<MatematikaSMPScreen> createState() => _MatematikaSMPScreenState();
}

class _MatematikaSMPScreenState extends State<MatematikaSMPScreen> {
