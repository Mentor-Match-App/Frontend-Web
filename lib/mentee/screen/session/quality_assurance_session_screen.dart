...
class QualityAssuranceSessionScreen extends StatefulWidget {
  QualityAssuranceSessionScreen({Key? key}) : super(key: key);

  @override
  State<QualityAssuranceSessionScreen> createState() =>
      _QualityAssuranceSessionScreenState();
}

class _QualityAssuranceSessionScreenState
    extends State<QualityAssuranceSessionScreen> {
