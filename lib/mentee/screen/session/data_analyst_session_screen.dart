...
class DataAnalystSessionScreen extends StatefulWidget {
  DataAnalystSessionScreen({Key? key}) : super(key: key);

  @override
  State<DataAnalystSessionScreen> createState() =>
      _DataAnalystSessionScreenState();
}

class _DataAnalystSessionScreenState extends State<DataAnalystSessionScreen> {
