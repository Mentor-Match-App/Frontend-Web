...
class DetailMentorAllScreen extends StatefulWidget {
  ...
  final List<MentorReviewClassAll> mentorReviews;
  ...
  @override
  State<DetailMentorAllScreen> createState() => _DetailMentorAllScreenState();
}

class _DetailMentorAllScreenState extends State<DetailMentorAllScreen> {
