...
import 'package:my_flutter_app/Mentee/screen/PremiumClass/detailpremiumclassmentee_page.dart';
import 'package:my_flutter_app/widget/navbaruser.dart';

class MyClassMenteePage extends StatefulWidget {
  MyClassMenteePage({Key? key}) : super(key: key);

  @override
  State<MyClassMenteePage> createState() => _MyClassMenteePageState();
}
...
class _MyClassMenteePageState extends State<MyClassMenteePage>
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          const PremiumClassMenteeDetailPage()),
                                );
                              },
                              style: ButtonStyle(
