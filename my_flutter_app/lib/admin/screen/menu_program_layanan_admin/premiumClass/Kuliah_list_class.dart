...
class KuliahListPremiumClassAdminScreenState extends StatefulWidget {
  KuliahListPremiumClassAdminScreenState({Key? key}) : super(key: key);

  @override
  State<KuliahListPremiumClassAdminScreenState> createState() =>
      _KuliahListPremiumClassAdminScreenStateState();
}
...
class _KuliahListPremiumClassAdminScreenStateState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Kuliah", style: FontFamily().titleText.copyWith(
              fontSize: 12,
            ),),
      ),
      body: ListView(
