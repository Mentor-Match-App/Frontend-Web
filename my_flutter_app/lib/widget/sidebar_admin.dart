...
class _SideBarAdminState extends State<SideBarAdmin> {
  ...
  Widget _buildMenuSideBar(String text, IconData icon) {
    ...
    final textColor = isSelected ? ColorStyle().primaryColors : ColorStyle().disableColors;
    final iconColor = isSelected ? ColorStyle().primaryColors : ColorStyle().disableColors;
    final backgroundColor = isSelected ? ColorStyle().secondaryColors.withOpacity(0.1) : null;
