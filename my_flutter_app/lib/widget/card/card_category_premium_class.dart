...
class CategoryCardPremiumClass extends StatefulWidget {
  ...
  final String text;
  const CategoryCardPremiumClass({Key? key, required this.text, required this.onPressed}) : super(key: key);

  @override
  State<CategoryCardPremiumClass> createState() => _CategoryCardPremiumClassState();
}
